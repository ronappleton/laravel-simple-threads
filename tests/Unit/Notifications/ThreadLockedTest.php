...
class ThreadLockedTest extends TestCase
{
    private ThreadLocked $notification;
    ...
    protected function setUp(): void
    {
        ...
        Config::set('threads.notifications.comment_created.sms.message', 'Your thread has been locked');
        Config::set('threads.notifications.comment_created.database.message', 'Your thread has been locked');
        Config::set('threads.notifications.comment_created.email.message', 'Your thread has been locked');
        Config::set('threads.notifications.comment_created.push.message', 'Your thread has been locked');
        ...
        $this->notification = new ThreadLocked($thread);
    }
    ...
    public function testVonageMessageIsCorrect(): void
    {
        ...
        $this->assertSame('Your thread has been locked - http://localhost/thread?thread=some_string', $message->content);
    }
    ...
    public function testDatabaseMessageIsCorrect(): void
    {
        ...
        $this->assertSame('Your thread has been locked', $message['message']);
